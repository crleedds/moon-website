...
$price_tabs = array(
	'implant' => array(
		...
		'rows'  => md_parse_price_rows( md_content( 'price_tab_implant_rows', "일반 임플란트 (식립 1개) | 85만 원 | 국산 픽스처\n프리미엄 임플란트 (식립 1개) | 95만 원 | 메가젠·해외 픽스처\n임플란트 보철 (지르코니아) | 55만 원 | 심미·강도 우수\n임플란트 보철 (금 / 골드) | 105만 원 | 내구성·교합 안정\n뼈이식 (간단·소량) | 30만 원 | 뼈가 부족할 때\n뼈이식 (상악동 거상술 등) | 50만 원 | 윗턱 골량 부족\n디지털 가이드 수술 | +10만 원/치아 | 정밀 수술 옵션" ) ),
	),
	'ortho' => array(
		'label' => md_content( 'price_tab_ortho_label', '교정' ),
		'rows'  => md_parse_price_rows( md_content( 'price_tab_ortho_rows', "소아 교정 (1차) | 150만 원 | 만 7~10세 골든타임\n부분 교정 (앞니 등) | 250만 원 | 국소 부정만 교정\n투명 교정 (간단 케이스) | 190만 원 | SureSmile Lite\n투명 교정 (표준 케이스) | 320만 원 | SureSmile Standard\n투명 교정 (전체 교정) | 470만 원 | 2026 할인가\n메탈(금속) 브라켓 교정 | 420만 원 | 전통 교정\n심미(레진) 브라켓 교정 | 450만 원 | 브라켓 색 자연스럽게\n자가결찰 교정 (A-Line) | 500만 원 | 와이어 결찰 자동" ) ),
	),
	'crown' => array(
		'label' => md_content( 'price_tab_crown_label', '크라운·틀니' ),
		'rows'  => md_parse_price_rows( md_content( 'price_tab_crown_rows', "도자기 + 금속 크라운 (PFM) | 45만 원 | 대중 보급형\n지르코니아 크라운 (어금니) | 55만 원 | 강도·심미 균형\n지르코니아 크라운 (앞니) | 60만 원 | 심미 우선\n금 (골드) 크라운 | 95만 원 | 교합 안정\n세라믹 인레이 (부분 수복) | 35만 원 | 심미적 충전\n금 (골드) 인레이 | 55만 원 | 내구성 우선\n틀니 (부분 / 전체) | 150만 원 | 진단 후 견적" ) ),
	),
	'decay' => array(
		'label' => md_content( 'price_tab_decay_label', '충치·레진' ),
		'rows'  => md_parse_price_rows( md_content( 'price_tab_decay_rows', "레진 충전 (작은 충치, 1면) | 10만 원 | 치아 색 자연스럽게\n레진 충전 (중간 충치, 2면) | 15만 원 | 인접면 포함\n레진 충전 (큰 충치, 3면 이상) | 30만 원 | 광범위 수복\n깊은 충치 레진 (신경 근접) | 15만 원 | 심부 충치\n어금니 광범위 충치 (MO/DO 포함) | 30만 원 | 교두당 추가 5만\n어금니 광범위 충치 (MOD 포함) | 50만 원 | 최대 범위\n앞니 사이 틈 메우기 (디아스테마) | 20만 원 | 심미 보완\n치경부 마모증 (잇몸 라인 충전) | 7만 원 | 잇몸 경계\n레진 비니어 (앞니 심미) | 35만 원 | 변색 보완\n레진 코어 (크라운 토대) | 8만 원 | 보철 전 기둥\n신경치료 후 레진 충전 | 8만 원 | 신경치료 마감\n유치 레진 충전 (1면) | 8만 원 | 소아용\n유치 레진 충전 (2면 이상) | 10만 원 | 소아용" ) ),
	),
	'gum' => array(
		'label' => md_content( 'price_tab_gum_label', '잇몸·자연치아' ),
		'rows'  => md_parse_price_rows( md_content( 'price_tab_gum_rows', "스케일링 (보험, 연 1회) | 25,100 원 | 만 19세 이상\n스케일링 (추가) | 6만 원 | 비급여\n잇몸치료 (간단·보험) | 21,300 원 | 치주염 초기\n잇몸치료 (복잡·보험) | 25,000 원 | 치주염 진행\n잇몸 수술 + 뼈이식 | 치아당 30만 원 | 잇몸뼈 회복\n잇몸 PDRN 주사 | 5만 원 | 염증 완화\n신경치료 (전치) | 보험 적용 | 건강보험\n신경치료 (구치) | 보험 적용 | 건강보험" ) ),
	),
	'aesthetic' => array(
		'label' => md_content( 'price_tab_aesthetic_label', '심미·미백' ),
		'rows'  => md_parse_price_rows( md_content( 'price_tab_aesthetic_rows', "라미네이트 (앞니 심미) | 치아당 66만 원 | 부가세 포함\n치아 미백 (자가, 4주 키트) | 33만 원 | 집에서 사용\n치아 미백 (전문가, 당일 시술) | 33만 원 | 1-day 33~44만\n치아 미백 (전문가, 2일 시술) | 44만 원 | 2-day 44~55만\n잇몸 미백 | 악당 20만 원 | 잇몸 색 개선\n거미스마일 (잇몸 성형) | 치아당 20만 원 | 레이저 시술" ) ),
	),
	'kids' => array(
