...
$price_tabs = array(
	...
	'decay' => array(
		'label' => '충치·레진',
		'rows'  => array(
			array( '레진 충전 (작은 충치, 1면)',          '10만 원부터',  '치아 색 자연스럽게' ),
			array( '레진 충전 (중간 충치, 2면)',          '15만 원부터',  '인접면 포함' ),
			array( '레진 충전 (큰 충치, 3면 이상)',        '30만 원부터',  '광범위 수복' ),
			array( '깊은 충치 레진 (신경 근접)',           '15만 원부터',  '심부 충치' ),
			array( '어금니 광범위 충치 (MO/DO 포함)',      '30만 원부터',  '교두당 추가 5만' ),
			array( '어금니 광범위 충치 (MOD 포함)',        '50만 원부터',  '최대 범위' ),
			array( '앞니 사이 틈 메우기 (디아스테마)',     '20만 원부터',  '심미 보완' ),
			array( '치경부 마모증 (잇몸 라인 충전)',       '7만 원부터',   '잇몸 경계' ),
			array( '레진 비니어 (앞니 심미)',              '35만 원부터',  '변색 보완' ),
			array( '레진 코어 (크라운 토대)',              '8만 원',        '보철 전 기둥' ),
			array( '신경치료 후 레진 충전',                '8만 원',        '신경치료 마감' ),
			array( '유치 레진 충전 (1면)',                 '8만 원',        '소아용' ),
			array( '유치 레진 충전 (2면 이상)',            '10만 원',       '소아용' ),
		),
	),
	'gum' => array(
		'label' => '잇몸·자연치아',
		'rows'  => array(
			...
			array( '신경치료 (전치)',                       '보험 적용',     '건강보험' ),
			array( '신경치료 (구치)',                       '보험 적용',     '건강보험' ),
		),
	),
	'aesthetic' => array(
		'label' => '심미·미백',
