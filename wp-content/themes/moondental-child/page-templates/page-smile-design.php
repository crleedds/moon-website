...
<section class="md-section md-section--sm">
	<div class="md-container md-container--narrow">
		<div class="md-region-cta">
			<?php $chip = md_content( 'smile_cta_chip', '' ); if ( $chip ) : ?>
				<span class="md-region-cta__chip"><?php echo esc_html( $chip ); ?></span>
			<?php endif; ?>
			<h2 class="md-region-cta__title"><?php echo nl2br( esc_html( md_content( 'smile_cta_title', '' ) ) ); ?></h2>
			<p class="md-region-cta__lead"><?php echo esc_html( md_content( 'smile_cta_lead', '' ) ); ?></p>
