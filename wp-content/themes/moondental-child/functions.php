...
define( 'MOONDENTAL_VERSION', '3.59' );
...
<p>주차 후 병원 접수처에서 무료 등록 도와드리겠습니다.</p>
 ...
 * 조용히 빠지는 편이 낫다. */
foreach ( array( 'supply-schema', 'supply-core', 'supply-notice', 'supply-page', 'supply-accounts' ) as $_md_sup_f ) {
