...
function moondental_home_content_fields() {
	return array(
		...
		'seo' => array(
			...
			'fields' => array(
				// 홈
				'seo_home_title' => array( 'default' => '천안·아산 치과 | 천안·아산 임플란트·투명교정·자연치아살리기', 'label' => '홈 · 제목 (뒤에 병원명 자동)', 'type' => 'text' ),
...
function moondental_doctor_single_content_fields() {
	...
	$prefill_qa = array(
		...
		'kimsi' => "교정을 늦게 시작해도 괜찮을까요? | 성인 교정은 언제 시작하셔도 좋은 결과를 낼 수 있습니다. 다만 잇몸·치주 상태가 준비되어 있어야 합니다.\n"
			...
			. $default_qa_common,
		'leesu' => "보철과 원장으로서 가장 중요하게 여기시는 부분은? | 정확한 진단과 정밀한 치료입니다. 보철은 오래 써야 하기 때문에 처음 만들 때 잘 만드는 것이 무엇보다 중요합니다.\n"
		...
		'leech' => "미국·한국 양쪽에서 진료 경험을 하셨는데 우리 병원의 강점은? | 미국식 정밀 진단·계획 수립과 한국식 세심한 사후 관리를 결합한 시스템입니다. 각 장점을 접목해왔습니다.\n"
			...
			. $default_qa_common,
		'leeyi' => "치과교정과·인정의로서 교정 진료 방침은? | 얼굴 전체 균형과 저작·발음·턱관절까지 종합적으로 봅니다. 치아만 가지런히 하는 게 목적이 아닙니다.\n"
