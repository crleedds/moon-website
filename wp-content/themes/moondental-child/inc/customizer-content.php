...
function moondental_pricing_content_fields() {
	...
	// v3.42.1 · 레진 치료 비용 · 사용자님 최신 리스트 반영 + 환자 친화 용어
	// 참고 · CA = 치경부 마모증 (잇몸 경계) · 교두 = 치아 씹는 부분 돌기
	//        MO/DO = 옆면+씹는면 · MOD = 씹는면+양쪽 옆면
	$default_decay = "치경부 마모증 (잇몸 경계 시린 부위) | 8만 원 | CA · 시린 이 완화\n"
	                . "레진 · 한 면 충전 | 10만 원 | 씹는 돌기 하나당 5만 추가\n"
	                . "레진 · 한 면 (넓은 범위) | 15만 원 | 씹는 돌기 하나당 5만 추가\n"
	                . "레진 · 앞니 사이 틈 메우기 (정중이개) | 25만 원 | 앞니 심미 개선\n"
	                . "레진 · 두 면 충전 | 15만 원 | 씹는 돌기 하나당 5만 추가\n"
	                . "레진 · 두 면 (씹는 면 포함) | 30만 원 | 씹는 돌기 하나당 5만 추가\n"
	                . "레진 · 세 면 이상 | 30만 원 | 씹는 돌기 하나당 5만 추가\n"
	                . "레진 · 세 면 이상 (씹는 면 포함) | 35만 원 | 씹는 돌기 하나당 5만 추가\n"
	                . "레진 · 세 면 이상 (씹는 면·양쪽 옆면 모두) | 50만 원 | 씹는 돌기 하나당 5만 추가\n"
	                . "레진 · 치아 변색 (반점치) 부위 | 20만 원 | 심미 보완\n"
	                . "레진 비니어 (앞니 코팅) | 35만 원 | 변색·모양 개선\n"
	                . "레진 코어 (크라운 씌우기 전 기둥) | 8만 원 | 보철 준비\n"
	                . "신경치료 후 레진 마감 | 8만 원 | 신경치료 완료 시\n"
	                . "유치 레진 · 한 면 | 8만 원 | 아이용\n"
	                . "유치 레진 · 두 면 이상 | 10만 원 | 아이용";
