	...
	return array(
		...
		'footer_legal' => array(
			...
			'fields' => array(
				...
				'footer_legal_inst_name' => array( 'default' => '한아의료재단 문치과병원', 'label' => '의료기관 명칭 (상호)', 'type' => 'text' ),
				...
				'footer_legal_copyright_start' => array( 'default' => '2018', 'label' => '저작권 시작 연도 (© YYYY-현재)', 'type' => 'text' ),
				'footer_legal_extra' => array(
					'default' => '',
					'label' => '추가 안내문 (선택, 사업자 정보 아래 표시)',
					'type' => 'textarea',
				),
			),
		),
