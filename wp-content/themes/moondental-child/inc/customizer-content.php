...
function moondental_doctor_single_content_fields() {
	...
	/* v3.75 · 원장님들이 적어 주신 「진료분야」에 맞춘다
	 * (통합_홈페이지_의료진_소개자료.xlsx)
	 *
	 * 여섯 분 중 네 분(김세일·이수연·권혜진·이영일)은 지금 값이 적어 주신
	 * 진료분야를 이미 더 자세히 풀어 쓴 것이라 그대로 둔다.
	 * 정석형·이승주 원장님만 실제 진료 범위와 어긋나 있어 고친다. */
	$prefill_interests = array(
		'munes' => "종합 임상\n임플란트\n보철·심미\n국제 의료봉사\n지역사회 공헌",
		/* 적어 주신 진료분야 · 임플란트 · 보존 · 심미치료 · 치주 · 보철
		 * 지금까지는 치주만 다섯 줄로 적혀 있어 진료 범위가 좁게 보였다. */
		'jeong' => "임플란트\n보존 치료\n심미 치료\n치주 치료\n보철",
		/* 적어 주신 진료분야 · 보존 · 심미치료 · 치주 · 보철
		 * 「1차 진단」·「정기 검진」은 진료분야가 아니라 진료 과정이라 뺐다. */
		'leesj' => "보존 치료\n심미 치료\n치주 치료\n보철",
		'kimsi' => "보존 치료\n심미 치료\n보철 (크라운·브릿지)\n통합치의학\n무통 마취 (도포마취·미세바늘)",
		'leesu' => "치과 보철\n크라운·틀니\n통합치의학\n심미 보철\n보철 재료 선택",
		'kwon'  => "치과 보존\n신경치료·재근관치료\n충치치료\n자연치아 살리기\n근관 미세 수술",
