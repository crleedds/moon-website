...
function moondental_doctor_single_content_fields() {
	...
	$prefill_qa = array(
		...
		'leesj' => "종합 원장으로서 가장 자주 보시는 케이스는? | 충치·잇몸·보철이 복합된 케이스가 많습니다. 한 곳에서 전 과정을 해결하는 것이 환자분께 가장 편리합니다.\n"
		...
		'kwon'  => "보존과 원장으로서 자연치아 살리기의 원칙은? | 발치는 최후의 선택입니다. 신경치료·재근관치료로 살릴 수 있는 치아를 최대한 지키는 것이 저희 진료 철학입니다.\n"
