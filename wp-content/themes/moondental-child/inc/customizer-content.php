	...
	return array(
		...
		'hero_and_mission' => array(
			...
			'fields' => array(
				...
				'mission_certs' => array(
					'default' => "⭐|1990년대부터 임플란트를 식립해온 병원\n🏥|국가지정 구강검진 병원\n🌐|외국인환자 유치 의료기관\n🪖|미군 및 가족 치료기관\n🦷|천안시 치아사랑사업 협력병원\n🔗|삼성서울병원 협력병원\n➕|대한적십자사 협력병원",
		...
		'faq' => array(
			...
			'fields' => array(
				...
				'faq_2_a' => array( 'default' => '병원 지하 기계식 주차장(천안시 동남구 만남로 52 문타워)을 무료로 이용하실 수 있습니다. 기계식이라 SUV·대형차는 인근 신부 제5공영주차장(천안시 동남구 먹거리1길 10, 도보 5분)에 주차해주세요. 주차 후 병원 접수처에서 주차도장/주차권을 받아가세요.', 'label' => '②번 — 답변', 'type' => 'textarea' ),
		...
		'chrome' => array(
			...
			'fields' => array(
				...
				'breadcrumb_encyclopedia'  => array( 'default' => '치과 백과사전', 'label' => '브레드크럼 · 치과 백과사전 라벨', 'type' => 'text' ),
				...
				'ui_back_to_enc'          => array( 'default' => '← 전체 치과 백과사전으로', 'label' => 'UI · 사전으로 돌아가기 버튼', 'type' => 'text' ),
				...
				// v3.38.5 · 홈 섹션 aria-label (스크린리더용)
				'aria_sec_hero'           => array( 'default' => '문치과병원 소개', 'label' => 'Hero 섹션 · aria', 'type' => 'text' ),
				'aria_sec_hero_combined'  => array( 'default' => '문치과병원 첫 화면', 'label' => '통합 Hero 섹션 · aria', 'type' => 'text' ),
				'aria_sec_hero_certs'     => array( 'default' => '국가지정·협력 의료기관', 'label' => 'Hero certs 리스트 · aria', 'type' => 'text' ),
				'aria_sec_clinic_intro'   => array( 'default' => '문치과병원 진료 시스템 소개', 'label' => '진료 시스템 소개 섹션 · aria', 'type' => 'text' ),
				'aria_sec_dentalbot'      => array( 'default' => '구강 자가진단', 'label' => '자가진단 봇 섹션 · aria', 'type' => 'text' ),
				'aria_sec_dentalbot_cta'  => array( 'default' => '예약·상담 채널', 'label' => '자가진단 aside · aria', 'type' => 'text' ),
				'aria_sec_faq'            => array( 'default' => '자주 묻는 질문', 'label' => 'FAQ 섹션 · aria', 'type' => 'text' ),
				'aria_sec_cta_banner'     => array( 'default' => '예약 안내', 'label' => '하단 CTA 배너 · aria', 'type' => 'text' ),
				'aria_sec_facility'       => array( 'default' => '문치과병원 시설·장비', 'label' => '시설 섹션 · aria', 'type' => 'text' ),
				'aria_sec_location'       => array( 'default' => '오시는 길', 'label' => '오시는 길 섹션 · aria', 'type' => 'text' ),
				'aria_sec_notices'        => array( 'default' => '병원 소식', 'label' => '병원 소식 섹션 · aria', 'type' => 'text' ),
				'aria_sec_mission'        => array( 'default' => '병원 사명 · 협력 기관', 'label' => '사명 배너 섹션 · aria', 'type' => 'text' ),
				'aria_sec_services'       => array( 'default' => '진료안내', 'label' => '진료안내 섹션 · aria', 'type' => 'text' ),
				'aria_sec_strengths'      => array( 'default' => '문치과병원의 강점', 'label' => '강점 섹션 · aria', 'type' => 'text' ),
				'aria_sec_testimonials'   => array( 'default' => '환자 후기', 'label' => '후기 섹션 · aria', 'type' => 'text' ),
				'aria_sec_trust'          => array( 'default' => '문치과병원의 약속', 'label' => 'Trust band · aria', 'type' => 'text' ),
				'aria_sec_why'            => array( 'default' => '문치과병원의 차별점', 'label' => 'Why 섹션 · aria', 'type' => 'text' ),
				'aria_sec_naver_map'      => array( 'default' => '네이버 지도에서 위치 보기', 'label' => '네이버 지도 링크 · aria', 'type' => 'text' ),
				'aria_mobile_group'       => array( 'default' => '빠른 예약·문의', 'label' => '모바일 하단 CTA 바 · aria', 'type' => 'text' ),
				// v3.38.5 · Hero — md_content 통일 (기존 moondental_hero_* theme_mod는 폴백으로 유지)
				...
				// 치과 백과사전 아카이브 UI
				'enc_hero_eyebrow'        => array( 'default' => 'DENTAL ENCYCLOPEDIA · 치과 백과사전', 'label' => '치과 백과사전 · eyebrow', 'type' => 'text' ),
				'enc_hero_title'          => array( 'default' => '천안·아산 문치과병원 · 치과 백과사전', 'label' => '치과 백과사전 · 제목', 'type' => 'text' ),
				'enc_hero_lead'           => array( 'default' => '치과 진료·시술·질환에 대한 용어를 알기 쉽게 정리했습니다. 궁금한 용어를 검색하거나 카테고리·초성으로 찾아보세요.', 'label' => '치과 백과사전 · 설명', 'type' => 'textarea' ),
				'enc_search_placeholder'  => array( 'default' => '🔍 용어 검색 (예: 임플란트, 스케일링, 라미네이트…)', 'label' => '치과 백과사전 · 검색 placeholder', 'type' => 'text' ),
				'enc_search_label'        => array( 'default' => '용어 검색', 'label' => '치과 백과사전 · 검색 sr-only 라벨', 'type' => 'text' ),
				'enc_search_btn'          => array( 'default' => '검색', 'label' => '치과 백과사전 · 검색 버튼', 'type' => 'text' ),
				'enc_clear'               => array( 'default' => '전체 보기', 'label' => '치과 백과사전 · 필터 초기화', 'type' => 'text' ),
				'enc_cats_all'            => array( 'default' => '전체', 'label' => '치과 백과사전 · 카테고리 탭 · 전체', 'type' => 'text' ),
				'enc_cats_aria'           => array( 'default' => '분야', 'label' => '치과 백과사전 · 카테고리 탭 aria', 'type' => 'text' ),
				'enc_initials_aria'       => array( 'default' => '초성 필터', 'label' => '치과 백과사전 · 초성 탭 aria', 'type' => 'text' ),
				'enc_count_unit'          => array( 'default' => '개 용어', 'label' => '치과 백과사전 · 카운트 단위', 'type' => 'text' ),
				'enc_search_label_prefix' => array( 'default' => '검색어:', 'label' => '치과 백과사전 · 검색어 표시 접두', 'type' => 'text' ),
				'enc_empty_title'         => array( 'default' => '😔 검색 결과가 없습니다.', 'label' => '치과 백과사전 · 빈결과 · 제목', 'type' => 'text' ),
				'enc_empty_hint_tpl'      => array( 'default' => '다른 검색어를 시도하거나 {link}를 확인해보세요.', 'label' => '치과 백과사전 · 빈결과 · 힌트 ({link} 토큰)', 'type' => 'text' ),
				'enc_empty_hint_link'     => array( 'default' => '전체 용어', 'label' => '치과 백과사전 · 빈결과 · 링크 텍스트', 'type' => 'text' ),
			),
		),
		...
		'seo' => array(
			...
			'fields' => array(
				...
				// 임플란트
				'seo_implant_title' => array( 'default' => '천안 임플란트 · 네비게이션 임플란트센터 | 문치과병원', 'label' => '임플란트 센터 · 제목', 'type' => 'text' ),
				...
				// 투명교정
				'seo_ortho_title' => array( 'default' => '천안 투명교정 · 슈어스마일 교정센터 | 문치과병원', 'label' => '투명교정 센터 · 제목', 'type' => 'text' ),
				...
				// 자연치아 살리기
				'seo_preservation_title' => array( 'default' => '천안 신경치료·충치치료 · 자연치아보존센터 | 문치과병원', 'label' => '자연치아 · 제목', 'type' => 'text' ),
				...
				// 턱관절
				'seo_tmj_title' => array( 'default' => '천안 턱관절 치료 · 이갈이·턱 통증 클리닉 | 문치과병원', 'label' => '턱관절 · 제목', 'type' => 'text' ),
				...
				'seo_tmj_kw'    => array( 'default' => '천안·아산 턱관절, 아산 턱관절, 천안·아산 턱관절 치료, 아산 턱관절 치료, 천안 턱 소리, 천안 이갈이, 아산 이갈이, 천안·아산 턱관절 보톡스, 천안 스플린트', 'label' => '턱관절 · 키워드', 'type' => 'textarea' ),
				// 사랑니 발치
				'seo_wisdom_title' => array( 'default' => '천안 매복 사랑니 발치 · CBCT 안전 진단 | 문치과병원', 'label' => '사랑니 · 제목', 'type' => 'text' ),
				...
				'seo_wisdom_kw'    => array( 'default' => '천안·아산 사랑니 발치, 아산 사랑니 발치, 천안 매복 사랑니, 아산 매복 사랑니, 천안·아산 사랑니, 아산 사랑니, 천안 구강외과, 아산 구강외과', 'label' => '사랑니 · 키워드', 'type' => 'textarea' ),
				// 심미치료
				'seo_aesthetic_title' => array( 'default' => '천안 라미네이트·치아미백 · 심미치료 | 문치과병원', 'label' => '심미치료 · 제목', 'type' => 'text' ),
				...
				// 비용 안내
				'seo_pricing_title' => array( 'default' => '진료비 안내 · 임플란트·교정·라미네이트 비용 | 문치과병원', 'label' => '비용 안내 · 제목', 'type' => 'text' ),
				...
				// 의료진
				'seo_doctors_title' => array( 'default' => '의료진 소개 · 분야별 전문 원장 협진 | 문치과병원', 'label' => '의료진 · 제목', 'type' => 'text' ),
				...
				// 오시는 길
				'seo_location_title' => array( 'default' => '오시는 길 · 진료시간 · 주차 안내 | 문치과병원', 'label' => '오시는 길 · 제목', 'type' => 'text' ),
				...
				// 상담예약
				'seo_reservation_title' => array( 'default' => '상담 예약 · 네이버 예약·카카오톡 상담 | 문치과병원', 'label' => '상담예약 · 제목', 'type' => 'text' ),
				...
				// 30여년 발자취
				'seo_history_title' => array( 'default' => '병원 역사 · 1995년 개원 30여년 | 문치과병원', 'label' => '30여년 발자취 · 제목', 'type' => 'text' ),
				...
				// 기술력·시설
				'seo_facility_title' => array( 'default' => '시설·장비 · CBCT·구강스캐너·원내 기공실 | 문치과병원', 'label' => '기술력·시설 · 제목', 'type' => 'text' ),
				...
				'seo_facility_kw'    => array( 'default' => '천안·아산 치과 시설, 아산 치과 시설, 천안 디지털 치과, 아산 디지털 치과, 천안 CBCT, 아산 CBCT, 천안·아산 임플란트 가이드, 천안·아산 치과 장비', 'label' => '기술력·시설 · 키워드', 'type' => 'textarea' ),
				// FAQ
				'seo_faq_title' => array( 'default' => '자주 묻는 질문 FAQ · 예약·비용·진료 | 문치과병원', 'label' => 'FAQ · 제목', 'type' => 'text' ),
				...
				'seo_page_kw_tpl'    => array( 'default' => '천안·아산 치과, 아산 치과, 천안 {title}, 아산 {title}, {site}', 'label' => '기타 페이지 · 키워드 템플릿', 'type' => 'textarea' ),
				...
				'seo_single_kw_tpl'    => array( 'default' => '천안·아산 치과, 아산 치과, 천안·아산 치과 소식, 아산 치과 소식, {site}', 'label' => '소식 글 · 키워드 템플릿', 'type' => 'textarea' ),
...
function moondental_pricing_content_fields() {
	// v3.42.1 · 임플란트 · 환자 친화 용어
	$default_implant = "스테리오스 임플란트 | 85만~95만 원 | 국산 뿌리\n"
	                  . "오스템 임플란트 | 90만~100만 원 | 국산 뿌리\n"
	                  . "포인트 임플란트 (표면 UV 처리) | 95만~105만 원 | 국산 · 뼈 유합 촉진\n"
	                  . "메가젠 임플란트 (프리미엄) | 100만~110만 원 | 국산\n"
	                  . "임플란트 크라운 (도자기+금속) | 치아당 45만 원 | 보급형\n"
	                  . "임플란트 크라운 (지르코니아·어금니) | 치아당 55만 원 | 강도·자연스러움 균형\n"
	                  . "임플란트 크라운 (지르코니아·앞니) | 치아당 60만 원 | 심미 우선\n"
	                  . "임플란트 크라운 (금 재질) | 치아당 105만 원 | 씹는 힘 안정\n"
	                  . "임플란트 임시 치아 (고정형) | 치아당 15만 원 | 뼈 유합 대기 중\n"
	                  . "뼈이식 (간단 · PRP·PRF 포함) | 30만 원 | 뼈가 부족할 때\n"
	                  . "뼈이식 (윗턱 · 상악동 거상술 등) | 50만 원 | 윗턱 뼈 부족\n"
	                  . "컴퓨터 가이드 수술 (네비게이션) | 사분면당 10만 원 | 정밀 시뮬레이션\n"
	                  . "PDRN 재생 주사 (뼈 회복 촉진) | 부위당 5만 원 | ";

	// v3.42.1 · 교정 · 환자 친화 용어
	$default_ortho = "교정 진단비 (일반·투명) | 회당 20만 원 | 정밀 검사·시뮬레이션\n"
	                . "어린이 교정 (1차) | 150만~200만 원 | 만 7~10세 · 성장기 골든타임\n"
	                . "부분 교정 (앞니 위주) | 250만~300만 원 | 특정 부위만 이동\n"
	                . "투명 교정 · SureSmile 부분 | 190만 원 | 이동 단계 8단계 이하\n"
	                . "투명 교정 · SureSmile 일반 | 320만 원 | 이동 단계 9~16단계\n"
	                . "투명 교정 · SureSmile 전체 | 550만 원 | 이동 단계 17단계 이상\n"
	                . "일반 브라켓 교정 (은색 금속) | 420만 원 | 전통 방식\n"
	                . "심미 브라켓 교정 (치아색) | 450만 원 | 자연스러운 색\n"
	                . "자가결찰 교정 (A-Line) | 500만 원 | 마찰 적어 이동 부드러움\n"
	                . "악궁 확장장치 | 악당 50만 원 | 성장기 · 위/아래 폭 확장\n"
	                . "페이스 마스크 | 200만 원 | 성장기 골격 교정\n"
	                . "미니 스크류 (고정용) | 개당 5만 원 | 이동 방향 안정\n"
	                . "유지장치 · 안쪽 고정형 (위·아래) | 악당 15만 원 | 교정 후 필수 착용\n"
	                . "유지장치 · 투명 리테이너 | 악당 15만 원 | 야간 착용\n"
	                . "유지장치 재제작 (본원 교정) | 15만 원 | 분실·파손 시\n"
	                . "교정 후 발치 (본원 교정) | 치아당 5만 원 | \n"
	                . "재교정 | 50만 원 | ";

	// v3.42.1 · 크라운·틀니 · 환자 친화 용어
	$default_crown = "일반 크라운 (도자기+금속·PFM) | 치아당 45만 원 | 보급형\n"
	                . "지르코니아 크라운 (어금니) | 치아당 55만 원 | 강도·자연스러움 균형\n"
	                . "지르코니아 크라운 (앞니) | 치아당 60만 원 | 심미 우선\n"
	                . "골드 크라운 (금 재질) | 치아당 95만 원 | 씹는 힘 안정·오래감\n"
	                . "임시 크라운 | 치아당 5만 원 | 최종 보철 대기 중\n"
	                . "세라믹 인레이 · 한 면 | 치아당 35만 원 | 자연스러운 충전\n"
	                . "세라믹 인레이 · 두 면 이상 | 치아당 40만 원 | \n"
	                . "골드 인레이 · 한 면 | 치아당 55만 원 | 내구성 우선\n"
	                . "골드 인레이 · 두 면 | 치아당 65만 원 | \n"
	                . "골드 인레이 · 세 면 | 치아당 75만 원 | \n"
	                . "치아 기둥 · 스크류 (직접 세우기) | 20만 원 | 크라운 준비\n"
	                . "치아 기둥 · 세라믹 (자연색) | 30만 원 | 크라운 준비 · 앞니 심미\n"
	                . "치아 기둥 · 금속 주조 (앞니·작은 어금니) | 30만 원 | \n"
	                . "치아 기둥 · 금속 주조 (어금니 2가닥) | 35만 원 | \n"
	                . "치아 기둥 · 금속 주조 (어금니 3가닥) | 40만 원 | \n"
	                . "틀니 (부분/전체) | 150만 원 | 크라운 별도";

	// v3.42.4 · 레진 치료 비용 · 사용자님 요청 4항목 제거 (레진코어·신경치료 후·유치)
	$default_decay = "치경부 마모증 (잇몸 경계 시린 부위) | 8만 원 | \n"
	                . "레진 · 한 면 충전 | 10만 원 | \n"
	                . "레진 · 한 면 (넓은 범위) | 15만 원 | \n"
	...
	// v3.42.1 · 심미·미백 · 환자 친화 용어
	$default_aesthetic = "라미네이트 (앞니 얇게 붙이기) | 치아당 66만 원 | 부가세 포함\n"
	                    . "가정용 미백 · 4주 세트 | 33만 원 | 집에서 사용 · 부가세 포함\n"
	                    . "가정용 미백 · 장치 추가 | 5만 원 | 개인 맞춤 트레이\n"
	                    . "가정용 미백 · 약제 1주치 | 5만 원 | 약제 리필\n"
	                    . "가정용 미백 · 약제 4주치 | 15만 원 | 약제 리필\n"
	                    . "전문가 미백 · 1일 (2회) | 33만 원 | 병원 방문 1회 · 부가세 포함\n"
	                    . "전문가 미백 · 1일 (3회) | 44만 원 | 병원 방문 1회 · 부가세 포함\n"
	                    . "전문가 미백 · 2일 (총 3회) | 44만 원 | 병원 방문 2회 · 부가세 포함\n"
	                    . "전문가 미백 · 2일 (총 4회) | 55만 원 | 병원 방문 2회 · 부가세 포함\n"
	                    . "잇몸 미백 (검은 잇몸 색 개선) | 악당 20만 원 | 부가세 별도\n"
	                    . "잇몸 라인 성형 (거미 스마일) | 치아당 20만 원 | 웃을 때 잇몸 많이 보임 · 레이저";

	// v3.42.1 · 소아·예방 · 환자 친화 용어
	$default_kids = "실란트 (홈메우기·만 18세 이하 어금니) | 본인부담 21,700 원~ | 보험 · 충치 없는 큰어금니\n"
	              . "실란트 (비급여·작은 어금니) | 치아당 3만 원 | 예방 홈 메우기\n"
	              . "불소도포 (입 전체) | 3만 원 | 치아 강화·충치 예방\n"
	              . "시린 이 완화 처치 (6개 치아당) | 본인부담 8,700~13,500 원 | 지각과민\n"
	              . "덴탈 SPA (전문가 칫솔질·잇몸 마사지) | 5만 원 | \n"
	              . "공간 유지장치 · 크라운형 (유치 조기 상실) | 공간당 20만 원 | \n"
	              . "공간 유지장치 · 밴드형 | 공간당 15만 원 | \n"
	              . "은색 스테인리스 크라운 · 유치 (맞춤 제작) | 치아당 20만 원 | 어린이 어금니\n"
	              . "은색 스테인리스 크라운 · 영구치 (맞춤 제작) | 치아당 25만 원 | \n"
	              . "기성 크라운 · 유치 (즉시 장착) | 치아당 15만 원 | \n"
	              . "기성 크라운 · 영구치 (즉시 장착) | 치아당 20만 원 | ";

	// v3.42.1 · 턱관절 · 환자 친화 용어
	$default_tmj = "턱관절 보톡스 (씹는 근육 완화) | 20만 원 | 이갈이·턱 근육 통증\n"
	              . "PDRN 재생 주사 (턱관절강) | 20만 원 | 관절 염증 완화\n"
	              . "턱관절 스플린트 (야간 착용 · 딱딱한 재질) | 100만 원 | 정밀 맞춤\n"
	              . "이갈이 방지 나이트가드 (부드러운 재질) | 30만 원 | 야간 착용";
	...
	return array(
		...
		'location_parking' => array(
			...
			'fields' => array(
				...
				'loc_park_lead'      => array( 'default' => '🎫 주차 후 병원 접수처에서 주차도장/주차권을 받아가세요', 'label' => '주차 카드 — 설명', 'type' => 'textarea' ),
...
function moondental_testimonials_content_fields() {
	$defaults = array(
		...
		5 => array( 'name' => '정○○', 'gender' => '여성', 'age' => '40대', 'service' => '자연치아 살리기', 'rating' => '5', 'text' => '발치하고 임플란트 하라던 치아를 보존과 원장님이 살려주셨어요. 재근관치료로 자연치를 지킬 수 있어서 정말 감사합니다.' ),
...
function moondental_doctor_meta_content_fields() {
	...
	/* v3.45 · 진료센터 그룹 구분 폐지 — doctor_groups 패널 제거 */
	$groups = array(
		'doctor_roles' => array(
...
function moondental_doctor_single_content_fields() {
	...
	/* v3.31.1 · 원장별 Q&A + 진료 분야 프리필 (사용자님이 편집·삭제 가능) */
	...
	$prefill_qa = array(
		/* v3.74 · 2026-08-26 병원장님 서면 인터뷰 실제 답변으로 교체.
		 * 문서의 선택 문항 7개 중 2·5·7번, 그리고 필수 문항 8·9번을 싣는다. */
		'munes' => "진료를 하시면서 가장 중요하게 생각하는 것은 무엇인가요? | 제가 가장 중요하게 생각하는 원칙은 ‘치아가 아니라 사람을 치료한다’는 것입니다.<br><br>같은 증상이라도 나이와 건강 상태, 생활 습관, 경제적 여건이 다르기 때문에 치료 역시 환자에 맞게 달라져야 합니다.<br><br>특히 가능한 한 자연치아를 오래 보존하고, 꼭 필요한 치료를 선택하려고 노력합니다.<br><br>결국 좋은 치료란 의사가 하고 싶은 치료가 아니라, 환자에게 가장 필요하고 오래 도움이 되는 치료라고 생각합니다.\n"
			. "환자분들이 원장님을 어떤 의사로 기억해 주셨으면 좋겠나요? | 유명한 의사보다는 “내 이야기를 잘 들어주고, 내 입장에서 최선의 방법을 찾아준 의사”로 기억되고 싶습니다.<br><br>치료를 잘하는 것은 의사의 기본이고, 그 위에 환자를 이해하고 배려하는 마음이 있어야 한다고 생각합니다.<br><br>치료가 끝난 뒤에도 다시 찾아오고 싶고, 내 가족에게도 안심하고 소개할 수 있는 의사라면 더 바랄 것이 없겠습니다. 또 형편이 어렵거나 도움이 필요한 분들에게는 먼저 손을 내밀 수 있는 의사이고 싶습니다.<br><br>환자와 지역사회가 힘들 때 편안하게 기대어 쉴 수 있는 한 그루의 나무 같은 의사, 그렇게 기억된다면 제게 가장 큰 보람일 것입니다.\n"
			. "원장님께서 생각하시는 문치과만의 가장 큰 장점은 무엇인가요? | 문치과의 가장 큰 장점은 오랜 임상 경험과 전문성을 바탕으로 ‘사람을 먼저 생각하는 의료’를 꾸준히 실천해 왔다는 것입니다.<br><br>1996년 한아 임플란트 보철연구소 설립 이후 임플란트와 심미보철 분야의 연구와 교육을 지속하며 치료 수준을 높여왔습니다.<br><br>또한 의료진 간의 협진과 디지털 진료 시스템, 원내기공 시스템을 통해 진단부터 치료와 보철까지 보다 체계적이고 정밀한 진료를 위해 노력하고 있습니다.<br><br>동시에 장애인, 저소득층, 독거노인, 외국인 노동자 등 의료 사각지대를 위한 진료와 봉사도 꾸준히 이어왔습니다.<br><br>전문성은 끊임없이 높이되, 그 전문성은 결국 환자와 사회를 위해 사용되어야 한다 — 이것이 문치과가 지켜온 철학입니다. 한마디로 표현한다면 ‘실력은 높이고, 문턱은 낮추는 병원’, 그것이 우리 문치과병원이 추구하는 모습입니다.\n"
			. "임플란트 치료가 필요한지 판단할 때 가장 먼저 살펴보시는 부분은 무엇인가요? | 가장 먼저 보는 것은 “정말 이 치아를 살릴 수 없는가?”입니다.<br><br>임플란트가 아무리 발전해도 자신의 자연치아보다 좋은 인공치아는 없기 때문에, 살릴 수 있다면 자연치아 보존을 우선합니다.<br><br>임플란트가 꼭 필요하다면 잇몸뼈와 잇몸 상태, 전신질환, 주변 치아와 생활습관까지 종합적으로 살펴봅니다.<br><br>단순히 임플란트를 심는 데 그치지 않고 10년, 20년 후에도 편안하게 사용할 수 있는 치료를 목표로 합니다.\n"
			. "구강외과 진료를 하시면서 특히 중요하게 생각하는 부분은 무엇인가요? | 구강외과 진료에서는 무엇보다 정확한 진단, 철저한 계획, 그리고 안전을 중요하게 생각합니다.<br><br>치아와 잇몸뿐 아니라 전신질환과 복용약, 환자의 회복 능력까지 꼼꼼하게 확인합니다.<br><br>임플란트나 발치와 같은 수술에서는 치료 결과만큼 환자의 통증과 불안을 줄이는 것도 중요합니다.<br><br>또 수술로 끝나는 것이 아니라 회복과 사후관리까지 세심하게 살피려고 합니다.<br><br>제가 생각하는 좋은 진료는 “정확하게 진단하고, 안전하게 치료하며, 끝까지 책임지는 것”입니다.",
		/* v3.45 · 원장님 서면 인터뷰 실제 답변으로 교체 (문단 구분은 <br><br>) */
		'jeong' => "보철 치료에서 가장 중요하게 생각하는 기준은 무엇인가요? | 보철 치료에 100% 만족은 없다고 생각합니다. 완벽할 수 없다는 뜻이라기보다, 치료 결과에 쉽게 안주하지 않고 조금이라도 더 나은 결과를 위해 계속 고민해야 한다는 뜻입니다.<br><br>치료가 잘 마무리됐다고 해서 거기서 만족하기보다, 환자분께 더 나은 결과를 드릴 수 있는 부분이 없는지 한 번 더 살펴보려고 합니다.<br><br>특히 40대 환자분의 상악 전치부 치료가 기억에 남습니다. 치료 후 치아의 변화뿐 아니라 환자분이 스스로 외모를 가꾸는 데도 더 적극적인 모습을 보이셨습니다. 치과 치료가 치아의 변화에 그치지 않고 환자분의 일상에도 영향을 줄 수 있다는 것을 그때 느꼈습니다.<br><br>그래서 저는 결과에 쉽게 만족하기보다, 마지막까지 한 번 더 살피고 고민하는 과정을 중요하게 생각합니다.\n"
			. "잇몸 건강을 오래 유지하려면 무엇이 중요한가요? | 잇몸 건강은 한 번의 치료보다 꾸준히 관리하는 과정이 중요하다고 생각합니다.<br><br>하루 중 30분 정도는 구강 위생 관리에 시간을 들여보셨으면 합니다. 특별한 불편함이 없더라도 정기적으로 치과를 방문해 잇몸 상태를 확인하는 것도 중요합니다.<br><br>아프거나 문제가 생겼을 때만 치과를 찾기보다, 평소에도 자신의 치아와 잇몸 상태를 확인하고 꾸준히 관리해주셨으면 합니다. 불편함이 없을 때부터 관리하는 습관이 잇몸 건강을 오래 유지하는 데 가장 큰 역할을 합니다.\n"
			. "칫솔질 외에 치아와 잇몸 건강을 위해 어떤 관리가 도움이 되나요? | 칫솔질은 구강 관리의 기본이지만, 칫솔질과 함께 치간칫솔이나 치실, 워터픽 같은 보조 구강위생용품을 사용하는 것도 중요합니다.<br><br>치아 사이와 잇몸 주변은 칫솔만으로 관리하기 어려운 부분이 있기 때문에, 자신의 치아와 잇몸 상태에 맞는 방법을 찾아 꾸준히 사용해보셨으면 합니다.<br><br>처음에는 번거롭게 느껴질 수 있지만 하루하루 꾸준히 쓰는 것이 중요합니다. 어떤 방법이 본인에게 맞는지 모르겠다면 치과에서 현재 상태에 맞는 관리 방법을 안내받는 것도 좋습니다.<br><br>특별한 방법보다는 자신에게 맞는 관리를 꾸준히 이어가는 것이 가장 중요하다고 생각합니다.\n"
			. "환자분들에게 어떤 의사로 기억되고 싶으신가요? | 믿고 편하게 찾을 수 있는 의사로 기억되고 싶습니다.<br><br>치과 치료를 앞두고 걱정하거나 궁금한 점이 있을 때 어렵게 느껴지는 의사보다는, 부담 없이 이야기할 수 있는 의사가 되고 싶습니다.<br><br>치료가 필요한 순간뿐 아니라 치료가 끝난 뒤에도 궁금하거나 불편한 부분이 있을 때 편하게 다시 찾아오실 수 있었으면 합니다. 환자분들이 필요할 때 믿고 편하게 찾을 수 있는 의사로 기억해주신다면 좋겠습니다.",
		/* v3.74 · 서면 인터뷰 실제 답변으로 교체 */
		'leesj' => "진료를 하시면서 가장 보람을 느끼는 순간은 언제인가요? | 치료를 받은 뒤 환자분의 일상이 실제로 편해졌다는 이야기를 들을 때 가장 큰 보람을 느낍니다.<br><br>기억에 남는 말씀 중 하나가 “문치과에서 치료받고 식사를 잘해서 살이 쪘어요”라는 이야기였습니다.<br><br>치과 치료의 결과가 단순히 치아의 변화에서 끝나는 것이 아니라, 환자분이 다시 편하게 식사하고 생활하는 데 도움이 되었다는 이야기를 들으면 진료한 의사로서 큰 보람을 느낍니다.<br><br>제가 한 치료가 환자분의 일상에 좋은 변화로 이어졌다는 것을 느낄 때 가장 기쁩니다.\n"
			. "환자분들께 꼭 전하고 싶은 말씀이 있다면 자유롭게 들려주세요. | 환자분들이 치과를 편안한 집처럼 생각하시고 부담 없이 찾아오셨으면 합니다.<br><br>치과라고 하면 아프거나 치료가 필요할 때만 가는 곳으로 생각하기 쉽지만, 평소에도 자신의 치아 상태를 살펴보고 꾸준히 관리하는 것이 중요합니다.<br><br>작은 궁금증이나 불편함이 있을 때도 어렵게 생각하지 마시고 편하게 찾아와 말씀해주셨으면 합니다.<br><br>환자분들이 필요할 때 언제든 편안한 마음으로 찾을 수 있는 치과가 되었으면 좋겠습니다.\n"
			. "보철 치료를 할 때 환자분과 어떤 부분을 가장 중요하게 조율하시나요? | 기본적인 치과 치료의 원칙을 지키는 것이 가장 우선이라고 생각합니다.<br><br>그 원칙을 벗어나지 않는 범위 안에서 환자분이 치료를 통해 가장 원하는 것이 무엇인지 충분히 듣고, 가능한 방향을 함께 고민하려고 합니다.<br><br>의사가 생각하는 치료 방향만 일방적으로 정하기보다, 환자분의 생각과 원하는 부분도 치료 계획을 세우는 데 중요하다고 봅니다.<br><br>치료의 기본 원칙은 지키면서도 환자분이 원하는 방향을 최대한 반영하는 것이 제가 보철 치료를 계획할 때 중요하게 생각하는 부분입니다.\n"
			. "보철 치료 후 환자분들이 가장 신경 써야 하는 부분은 무엇인가요? | 새로운 보철물을 장착한 뒤에는 적응하는 시간을 충분히 갖는 것이 중요하다고 생각합니다.<br><br>보철물을 처음 사용하면 이전과 다른 느낌이 들 수 있기 때문에, 적응하는 동안에는 처음부터 무리하게 사용하기보다 조금 조심해서 사용해주셨으면 합니다.<br><br>새로운 보철물에 익숙해지는 과정도 치료의 한 부분이라고 생각합니다.<br><br>보철물을 장착한 직후에는 서두르지 말고 천천히 적응하면서 사용해주셨으면 합니다.",
		'kimsi' => "환자분들께 꼭 전하고 싶은 말씀이 있다면 자유롭게 들려주세요. | 치과 치료가 필요하다는 것을 알면서도 통증에 대한 걱정이나 진료실에서 느끼는 긴장감 때문에 치료를 미루시는 분들이 계십니다.<br><br>저는 이런 부담을 조금이라도 줄여드리는 것도 치료 과정에서 중요하다고 생각합니다. 그래서 문치과에서는 도포마취와 미세바늘을 사용하고, 환자분들이 조금 더 편안하게 진료받으실 수 있도록 쾌적하고 안정적인 진료 환경을 갖추고 있습니다.<br><br>치과 치료에 대한 걱정 때문에 필요한 치료를 계속 미루기보다는, 먼저 현재 상태를 확인해보셨으면 합니다.<br><br>저도 환자분들이 치료에 대한 부담을 조금 덜고 편안한 마음으로 진료받으실 수 있도록 세심하게 살피려고 합니다.\n"
			. "원장님께서 생각하시는 문치과의 강점은 무엇인가요? | 제가 생각하는 문치과의 가장 큰 장점은 오랜 임상 경험과 분과별 진료, 그리고 원내 기공실입니다.<br><br>환자분마다 필요한 치료가 다르기 때문에 한 가지 분야만 보는 것보다, 필요한 경우 여러 진료 분야에서 함께 살펴볼 수 있는 환경이 중요합니다.<br><br>또한 보철 치료 과정에서는 원내 기공실과 함께할 수 있다는 점도 문치과가 가진 장점 중 하나라고 생각합니다.<br><br>오랜 시간 쌓아온 진료 경험과 각 분야가 함께할 수 있는 진료 환경이 문치과의 강점이라고 생각합니다.\n"
			. "치아를 씌우고 나서 찬물에 시린데 괜찮은가요? | 충치를 제거하고 새로운 보철물을 씌운 뒤에는 치아가 새 보철물에 적응하는 과정에서 일시적으로 시린 느낌이 나타날 수 있습니다.<br><br>제가 환자분들께 설명드릴 때도 처음에는 이런 불편함이 있을 수 있다는 점을 말씀드립니다. 대부분은 적응 기간이 지나면서 자연스럽게 완화됩니다.<br><br>새로운 보철물을 사용하기 시작한 직후에는 이전과 다른 느낌 때문에 걱정하시는 분들도 있지만, 어느 정도 적응하는 시간이 필요할 수 있습니다.<br><br>치료 후 나타날 수 있는 변화에 대해 미리 알고 계시면 불필요한 걱정을 조금 덜 수 있다고 생각합니다.\n"
			. "치료를 마친 후 환자분들이 꼭 기억하셨으면 하는 관리 방법이 있을까요? | 치료를 잘 받는 것만큼 치료 후의 구강 위생 관리도 중요하다고 생각합니다.<br><br>치료가 끝난 뒤에도 식사 후에는 치실과 치간칫솔을 사용해 치아 사이에 음식물이 남지 않도록 관리해주시는 것이 좋습니다. 칫솔질만으로 관리하기 어려운 부분까지 꾸준히 살펴주는 습관이 필요합니다.<br><br>그리고 특별한 불편함이 없더라도 정기적으로 치과를 방문해 치료한 치아와 주변 상태를 확인해주셨으면 합니다.<br><br>치료가 끝났다고 관리까지 끝나는 것은 아니기 때문에, 평소의 꾸준한 관리와 정기검진을 꼭 이어가셨으면 합니다.",
		'leesu' => "환자분들께 꼭 전하고 싶은 말씀이 있다면 자유롭게 들려주세요. | 치아 관리의 기본은 정기적인 검진이라고 생각합니다.<br><br>특별한 불편함이 없으면 치과 방문을 미루기 쉽지만, 문제가 생긴 뒤에 치료하는 것보다 평소에 상태를 확인하면서 관리하는 것이 더 중요합니다.<br><br>치료를 받은 치아나 보철물도 치료가 끝났다고 해서 관리까지 끝나는 것은 아닙니다. 정기적으로 상태를 확인하고, 평소 관리가 잘되고 있는지도 함께 살펴보는 과정이 필요합니다.<br><br>저는 환자분들이 치과를 아플 때만 찾는 곳으로 생각하기보다, 지금의 치아를 오래 건강하게 유지하기 위해 꾸준히 관리받는 곳으로 생각해주셨으면 합니다.\n"
			. "원장님께서 생각하시는 문치과의 강점은 무엇인가요? | 제가 생각하는 문치과의 가장 큰 장점은 오랜 임상 경험과 다양한 진료 케이스입니다.<br><br>환자분마다 치아 상태와 필요한 치료가 다르기 때문에, 여러 진료 경험을 바탕으로 현재 상태를 폭넓게 살펴볼 수 있다는 점이 중요합니다.<br><br>저 역시 여러 치료 방법 가운데 어떤 방향이 환자분에게 더 적합한지 설명하고 상담할 때, 그동안 쌓아온 다양한 진료 경험이 도움이 된다고 생각합니다.<br><br>한 가지 방법만 보는 것이 아니라 환자분의 상태에 맞는 치료 방향을 여러 가지로 살펴볼 수 있다는 점이 문치과의 강점이라고 생각합니다.\n"
			. "보철 치료를 받으시는 환자분들이 가장 자주 궁금해하시는 점은 무엇인가요? | 환자분들이 가장 많이 궁금해하시는 것은 “여러 치료 방법 중 어떤 방법이 나에게 맞는가” 하는 부분입니다.<br><br>같은 보철 치료라도 환자분의 상태에 따라 선택할 수 있는 방법이 달라질 수 있기 때문에, 저는 먼저 가능한 치료 방법과 각각의 차이를 충분히 설명드리려고 합니다.<br><br>치료 방법을 일방적으로 정해서 말씀드리기보다, 환자분이 자신의 상태와 치료 방법을 이해할 수 있도록 상담하는 과정을 중요하게 생각합니다.<br><br>환자분이 왜 이 치료가 필요한지 이해하고, 본인에게 맞는 방향을 충분히 납득한 뒤 치료를 시작하는 것이 중요합니다.\n"
			. "건강한 치아를 오래 유지하기 위해 평소 꼭 실천하거나 피해야 할 습관이 있다면 알려주세요. | 평소 이를 꽉 무는 습관이 있다면 주의하셨으면 합니다. 반복적으로 이를 꽉 물면 치아나 보철물에 부담이 될 수 있기 때문입니다.<br><br>구강 위생 관리에서는 칫솔질과 함께 치간칫솔을 꾸준히 사용하는 것도 권해드립니다. 칫솔만으로 닦기 어려운 치아 사이를 관리하는 데 도움이 됩니다.<br><br>거창한 방법을 한 번에 많이 실천하기보다, 자신에게 필요한 관리 방법을 꾸준히 생활 속에서 이어가는 것이 더 중요하다고 생각합니다.",
		/* v3.74 · 서면 인터뷰 실제 답변으로 교체 */
		'kwon'  => "진료를 하실 때 가장 중요하게 생각하시는 부분은 무엇인가요? | 가능하다면 현재의 치아를 오래 사용할 수 있는 방법이 있는지 먼저 살펴보는 것이 중요하다고 생각합니다.<br><br>같은 증상이 있더라도 치아가 손상된 정도나 현재 상태는 환자분마다 다르기 때문에, 먼저 치아의 상태를 충분히 확인한 뒤 어떤 치료가 필요한지 판단하는 과정이 필요합니다.<br><br>보존 진료에서는 문제가 있는 부분을 치료하는 것뿐만 아니라, 현재 남아 있는 치아를 어떻게 하면 오래 유지할 수 있을지 함께 살펴보는 것도 중요하다고 생각합니다.<br><br>저는 필요한 치료는 놓치지 않으면서도, 유지할 수 있는 치아라면 가능한 한 오래 사용할 수 있는 방향을 고민하려고 합니다.\n"
			. "환자분들께 꼭 전하고 싶은 말씀이 있다면 자유롭게 들려주세요. | 치아가 많이 아파진 뒤에만 치과를 찾기보다, 특별한 불편함이 없을 때부터 정기적으로 상태를 확인해보셨으면 합니다.<br><br>치아의 문제는 처음부터 큰 불편함으로 나타나는 경우만 있는 것은 아니기 때문에, 평소 자신의 치아 상태를 확인하는 것이 중요합니다.<br><br>문제가 커진 뒤 치료를 시작하는 것보다 정기적인 검진을 통해 변화가 있는지 살펴보고, 필요한 시기에 적절한 관리를 받는 것이 치아를 오래 사용하는 데 도움이 됩니다.<br><br>아프지 않더라도 내 치아가 어떤 상태인지 꾸준히 확인하는 습관을 가져주셨으면 합니다.\n"
			. "자연치아를 살릴 수 있는지 판단할 때 어떤 부분을 살펴보시나요? | 자연치아를 유지할 수 있는지는 한 가지 기준만으로 판단하기 어렵습니다.<br><br>먼저 현재 치아가 어느 정도 손상되어 있는지, 남아 있는 치아의 상태는 어떤지 등을 충분히 살펴보는 것이 중요하다고 생각합니다.<br><br>치아의 상태를 정확하게 확인한 뒤 현재 상황에서 보존할 수 있는 방법이 있는지를 살펴보고, 그에 맞는 치료 방향을 정하게 됩니다.<br><br>가능하다면 자신의 치아를 오래 사용할 수 있도록 현재 상태에 맞는 방법을 찾는 것이 보존 진료에서 중요하다고 생각합니다.\n"
			. "충치나 신경치료를 미루지 않고 적절한 시기에 치료받는 것이 중요한 이유는 무엇인가요? | 치아의 문제는 시간이 지나면서 치료가 필요한 범위가 달라질 수 있습니다.<br><br>불편함이 있는데도 오래 참고 지내기보다, 문제가 느껴졌을 때 먼저 상태를 확인해보시는 것이 좋다고 생각합니다.<br><br>현재 치아가 어떤 상태인지 일찍 확인하면 필요한 치료가 무엇인지 판단할 수 있고, 앞으로 어떻게 관리해야 하는지도 함께 알아볼 수 있습니다.<br><br>치아를 오래 사용하기 위해서는 치료가 필요한 시기를 놓치지 않는 것도 중요합니다. 조금이라도 불편함이 느껴진다면 너무 오래 미루지 말고 치과에서 상태를 확인해보셨으면 합니다.",
		...
		'leech' => "미국·한국 양쪽에서 진료 경험을 하셨는데 우리 병원의 강점은? | 미국식 정밀 진단·계획 수립과 한국식 세심한 사후 관리를 결합한 시스템입니다. 각 장점을 접목해왔습니다.\n"
			...
			. $default_qa_common,
		'leeyi' => "진료를 하시면서 가장 중요하게 생각하는 것은 무엇인가요? | 교정 치료에서 가장 중요한 것은 정확한 진단이라고 생각합니다.<br><br>환자분마다 치아의 배열이나 교합 상태, 치료가 필요한 범위가 다르기 때문에 치료를 시작하기 전에 현재 상태를 정확하게 파악하는 것이 먼저입니다.<br><br>진단이 정확해야 그에 맞는 치료 계획을 세울 수 있고, 치료가 진행되는 동안에도 처음 정한 방향을 기준으로 과정을 살펴볼 수 있습니다.<br><br>교정 치료는 비교적 긴 기간 동안 진행되는 만큼, 정확한 진단을 바탕으로 치료 방향을 정하고 계획에 따라 차근차근 진행하는 것을 중요하게 생각합니다.\n"
			. "진료를 하시면서 가장 보람을 느끼는 순간은 언제인가요? | 치료를 잘 마친 뒤 환자분이 결과에 만족해하실 때 가장 큰 보람을 느낍니다.<br><br>교정 치료는 한 번의 진료로 끝나는 것이 아니라 일정 기간 동안 치아의 변화를 지켜보며 이어가는 치료입니다. 처음 진단했던 상태에서 조금씩 변화하는 과정을 거쳐 마지막 결과를 확인하기까지 긴 시간이 필요합니다.<br><br>그 과정을 잘 마치고 환자분이 변화된 모습에 만족해하시는 것을 보면, 그동안의 치료가 좋은 결과로 이어졌다는 점에서 보람을 느낍니다.\n"
			. "교정 치료를 고민하는 환자분들께 가장 먼저 해드리고 싶은 말씀이 있으신가요? | 교정 치료에 필요한 2년 내외의 시간이 처음에는 길게 느껴질 수 있습니다. 치료 기간 때문에 시작을 고민하시는 분들도 계십니다.<br><br>하지만 앞으로 오랫동안 얻게 될 변화를 생각한다면, 치료에 필요한 2년이라는 시간이 꼭 길기만 한 것은 아니라고 생각합니다.<br><br>치료 기간 자체만 보기보다 치료가 끝난 뒤의 시간을 함께 생각해보셨으면 합니다. 자신의 상태와 치료 방향에 대해 충분히 설명을 듣고 고민한 뒤 치료가 필요하다고 판단되신다면, 기간 때문에 너무 부담을 갖지는 않으셨으면 합니다.\n"
			. "성공적인 교정 치료를 위해 환자분들이 꼭 기억하셨으면 하는 것이 있다면 무엇인가요? | 교정 치료에서는 담당의와 환자분 사이의 신뢰가 중요하다고 생각합니다.<br><br>교정은 일정 기간 동안 계속해서 진행되는 치료이기 때문에, 치료 과정에서 안내드리는 내용을 잘 이해하고 꾸준히 따라와 주시는 것이 필요합니다.<br><br>긴 치료 기간 동안에는 변화가 바로 느껴지지 않는 때도 있습니다. 그럴 때도 담당의와 충분히 소통하면서 치료 과정을 이어가셨으면 합니다. 담당의를 믿고 치료 과정을 잘 따라와 주시면 좋은 결과를 얻는 데 도움이 됩니다.",
	);

	/* 진료 분야 (v3.76)
	 *
	 * 여섯 분은 소개자료(통합_홈페이지_의료진_소개자료.xlsx)의 「진료분야」 칸에
	 * 직접 적어 주신 그대로 쓴다. 우리가 임의로 풀어 쓰거나 덧붙이지 않는다 —
	 * 어느 진료를 보시는지는 원장님 본인이 정하실 일이다.
	 *
	 * 자료가 없는 세 분(문은수·문지현·이창률)은 프로젝트에 이미 정리돼 있던
	 * 진료분야 분류(moon-dental-staff.html 의 fields)를 그대로 옮겼다.
	 * 문은수 이사장님의 구강외과는 서면 인터뷰의 필수 문항(9번)이 그 진료를
	 * 전제하고 있어 함께 넣었다. 세 분 자료를 받으면 위 여섯 분처럼 맞춘다.
	 *
	 * v3.75 까지 「관심 분야」로 부르며 진료가 아닌 항목(국제 의료봉사,
	 * 지역사회 공헌, 미국·한국 협진)이 섞여 있었다. 이름을 진료 분야로
	 * 바꾸면서 그런 줄은 뺐다. */
	$prefill_interests = array(
		/* 자료 없음 — 기존 분류 + 인터뷰 9번(구강외과) */
		'munes' => "임플란트\n구강외과\n보철 · 심미",
		/* 아래 여섯 분 — 소개자료에 적어 주신 진료분야 그대로 */
		'jeong' => "임플란트\n보존\n심미치료\n치주\n보철",
		'leesj' => "보존\n심미치료\n치주\n보철",
		'kimsi' => "보존\n심미치료\n보철",
		'leesu' => "보철\n통합치의학",
		...
		'munji' => "임플란트\n턱관절\n교정",
		'leech' => "임플란트\n교정\n턱관절\n보철 · 심미",
		/* 소개자료에 적어 주신 진료분야 그대로 */
		'leeyi' => "치과 교정과",
	);

	/* 9명 개별 — intro / 자격사항 4개 / Q&A / 진료 분야 (v3.31.1 프리필 defaults 적용) */
	...
	return array(
		...
		'endo' => array(
			...
			'fields' => array(
				...
				'preservation_endo_lead'    => array( 'default' => '충치가 신경까지 도달한 경우, 신경치료로 발치를 막고 자연치아를 살립니다. 보존과 진료팀의 정밀 근관치료.', 'label' => '섹션 리드', 'type' => 'textarea' ),
	...
	return array(
		...
		'traffic' => array(
			...
			'fields' => array(
				...
				'region_traffic_bus_detail' => array( 'default' => '천안시외버스터미널·천안고속버스터미널에서 문치과병원까지 도보 약 5분.', 'label' => '버스 카드 · 부가 안내', 'type' => 'textarea' ),
...
function moondental_bot_content_fields() {
	return array(
		'ui' => array(
			'title'  => '셀프진단봇 · UI 문구',
			'fields' => array(
				'bot_count_template'    => array( 'default' => '{count}개의 Yes/No 질문 · 부위 선택 시 관련 10문항만 진행 · 약 1분', 'label' => '질문 개수 안내 (토큰 {count})', 'type' => 'text' ),
				'bot_intro_title'       => array( 'default' => '임상 증상 기반 자가진단', 'label' => '시작 화면 · 제목', 'type' => 'text' ),
				...
				'bot_result_lead'       => array( 'default' => '입력하신 임상 증상에 기반해 필요할 수 있는 진료 영역을 안내해드립니다. 확진은 임상·방사선 검사가 필요합니다.', 'label' => '결과 화면 · 리드', 'type' => 'textarea' ),
		...
		'questions' => array(
			'title'  => '셀프진단봇 · 임상 증상 기반 (카테고리별 10문항 · 총 50)',
			'fields' => array(
				'bot_questions' => array(
					// v3.44.67 · 임상 증상 중심 · '~치료 원하세요?' 형 제거 · 의학적 관찰 소견 기반
					'default' =>
						// ── 치아 문제 (10) · 통증·손상·감염 ──
						"응급 통증 | 잠들 수 없는 극심한 치통이 있거나, 진통제로도 완화되지 않는 지속적 치통이 있나요? (치수염·급성 감염 의심) | 자연치아-살리기:4, 사랑니-발치:2 | 치아 | urgent\n" .
						"자발통 | 자극이 없는데도 욱신거리며 아프거나, 특정 부위 통증이 얼굴 한쪽으로 방사되나요? (근관 치료 적응증) | 자연치아-살리기:4 | 치아\n" .
						"온도 자극통 | 찬 것·뜨거운 것에 시리고, 자극이 사라진 뒤에도 통증이 30초 이상 지속되나요? (비가역성 치수염 감별) | 자연치아-살리기:3 | 치아\n" .
						"저작통 | 특정 치아로 씹을 때 예리한 통증이 있어 그 쪽으로 씹기를 피하게 되나요? (치아 균열·근단 병소 의심) | 자연치아-살리기:3, 사랑니-발치:1 | 치아\n" .
						"지각과민 | 잇몸선 근처·노출된 치근 부위가 브러싱·냉기 자극에 시린 증상이 있나요? (치경부 마모·지각과민증) | 자연치아-살리기:2, 예방클리닉:1 | 치아\n" .
						"치아 파절 | 치아가 깨지거나 크라운·인레이·필링이 탈락하여 노출된 상태로 방치된 부위가 있나요? | 자연치아-살리기:3, 임플란트-센터:1 | 치아 | urgent\n" .
						"치아 동요 | 손·혀로 밀었을 때 치아가 흔들리거나, 씹을 때 밀려나는 느낌이 있나요? (치주 지지 소실) | 자연치아-살리기:3, 임플란트-센터:1 | 치아\n" .
						"치아 상실 | 발치·사고로 빠진 치아 자리가 방치되어 저작·발음·심미에 지장이 있나요? | 임플란트-센터:4 | 치아\n" .
						"보철 실패 | 기존 크라운·브릿지·틀니·임플란트가 흔들리거나, 그 밑에서 통증·냄새·재발 우식이 발생하나요? | 임플란트-센터:3, 자연치아-살리기:1 | 치아\n" .
						"사랑니 병변 | 제3대구치(사랑니) 부위에 부종·통증이 있거나, 매복 사랑니로 발치를 권유받은 적 있나요? | 사랑니-발치:4 | 치아\n" .
						// ── 잇몸·구강 (10) · 치주·점막 ──
						"자발 출혈 | 양치·치실 시 잇몸에서 자주 피가 나거나, 자극 없이도 배어나오는 출혈이 있나요? (치은염) | 자연치아-살리기:3, 예방클리닉:1 | 잇몸\n" .
						"잇몸 부종 | 잇몸이 붉게 부어 있고 치간유두(치아 사이 잇몸) 부위가 둥글게 부풀어 있나요? (활동성 치주 염증) | 자연치아-살리기:3, 예방클리닉:1 | 잇몸\n" .
						"치은 퇴축 | 잇몸선이 내려가 치아가 길어 보이거나 치근이 드러나 있나요? (치주염 진행) | 자연치아-살리기:4 | 잇몸\n" .
						"농양·누공 | 잇몸에 여드름 같은 종기가 있거나, 눌렀을 때 고름·짠맛 액체가 나오나요? (근단·치주 농양) | 자연치아-살리기:4, 사랑니-발치:2 | 잇몸 | urgent\n" .
						"치석 축적 | 혀로 치아를 훑을 때 거친 느낌이 있거나, 마지막 스케일링 이후 1년 이상 경과했나요? | 예방클리닉:3, 자연치아-살리기:1 | 잇몸,예방\n" .
						"지속성 구취 | 양치 후에도 사라지지 않는 지속적 구취가 있거나, 주변에서 지적을 받은 적 있나요? | 자연치아-살리기:2, 예방클리닉:2 | 잇몸\n" .
						"치간 공극 증가 | 치아 사이가 예전보다 넓어져 음식이 점점 더 자주 끼거나 치실 통과가 쉬워졌나요? (치조골 흡수) | 자연치아-살리기:2, 투명교정-센터:1 | 잇몸\n" .
						"구강건조 | 복용 약물·전신질환·방사선 이력으로 침 분비가 감소해 입안이 마르는 증상이 있나요? (다발성 우식 위험) | 예방클리닉:3 | 잇몸\n" .
						"재발성 궤양 | 구강 점막(입술·볼·혀)에 궤양(아프타)이 2주 이상 지속되거나 자주 재발하나요? | 예방클리닉:2, 자연치아-살리기:1 | 잇몸\n" .
						"점막 병변 | 구강 내에 하얀 반점·붉은 반점·경화된 종괴 등 지속되는 병변이 있나요? (점막 진단 필요) | 예방클리닉:2, 자연치아-살리기:1 | 잇몸 | urgent\n" .
						// ── 턱관절·얼굴 (10) · TMD·근막 ──
						"관절 잡음 | 개구·폐구 시 편측 또는 양측 관절에서 딸깍음(클릭)·마찰음(크레피터스)이 나나요? | 턱관절-클리닉:4 | 턱관절\n" .
						"관절 압통 | 귀 앞(TMJ) 부위를 눌렀을 때 통증이 있거나, 씹을 때 관절 통증이 있나요? | 턱관절-클리닉:4 | 턱관절\n" .
						"개구 제한 | 손가락 3개(약 40mm)가 세로로 안 들어갈 정도로 입 벌리기가 제한되나요? | 턱관절-클리닉:4 | 턱관절\n" .
						"개구시 편위 | 입을 벌릴 때 아래턱이 좌우 한쪽으로 치우쳐 지그재그로 움직이나요? (관절원판 전위 의심) | 턱관절-클리닉:3 | 턱관절\n" .
						"수면 이갈이 | 가족·파트너로부터 자면서 이 가는 소리가 들린다고 지적받은 적 있나요? (Bruxism) | 턱관절-클리닉:3, 심미치료:1 | 턱관절\n" .
						"주간 이악물기 | 낮에 집중·긴장·운전 등 상황에서 자신도 모르게 어금니를 물고 있음을 자각하나요? (Clenching) | 턱관절-클리닉:3 | 턱관절\n" .
						"저작근 압통 | 볼(교근)·관자놀이(측두근)를 눌렀을 때 국소 압통이 있거나, 근육이 딱딱하게 뭉쳐 있나요? | 턱관절-클리닉:3 | 턱관절\n" .
						"측두부 두통 | 오후로 갈수록 심해지는 관자놀이·측두부 두통이 이악물기와 연관되어 있나요? (긴장성 두통) | 턱관절-클리닉:2 | 턱관절\n" .
						"경부·어깨 통증 | 턱 통증과 함께 목·어깨 근육 긴장·통증이 동반되나요? (관련 근막통증증후군) | 턱관절-클리닉:2 | 턱관절\n" .
						"교합 부조화 | 예전과 씹는 느낌이 달라져 위아래 치아가 안 맞거나, 자연스러운 폐구 위치를 못 찾겠나요? | 턱관절-클리닉:2, 투명교정-센터:2 | 턱관절,심미\n" .
						// ── 심미·미소 (10) · 배열·색·형태 ──
						"치열 부정 | 치아가 겹쳐 있거나 회전되어 배열이 고르지 않나요? (총생·회전) | 투명교정-센터:4 | 심미\n" .
						"상악 전돌 | 옆모습에서 위 앞니가 아래턱보다 눈에 띄게 앞으로 나와 보이나요? | 투명교정-센터:4 | 심미,치아\n" .
						"수직 개방교합 | 입을 다물었을 때 위아래 앞니 사이에 틈이 생기거나, 앞니로 음식이 잘 안 물리나요? | 투명교정-센터:3, 턱관절-클리닉:1 | 심미,턱관절\n" .
						"정중이개 | 앞니(중절치) 사이가 벌어져 있어 자연스러운 미소에 방해가 되나요? (Diastema) | 심미치료:3, 투명교정-센터:2 | 심미\n" .
						"치아 착색 | 치아 전반이 어둡거나 특정 치아가 회색·갈색을 띠어 미백치약으로 개선되지 않나요? (내인·외인성 착색 감별) | 심미치료:3 | 심미\n" .
						"치은 색소침착 | 잇몸 표면이 검거나 얼룩덜룩하게 색소침착이 있어 심미적으로 신경 쓰이나요? | 심미치료:3 | 심미\n" .
						"앞니 형태 이상 | 앞니의 크기·비율·길이·모서리 형태가 옆 치아와 조화롭지 않다고 느끼시나요? | 심미치료:4 | 심미\n" .
						"치은 노출 과다 | 웃을 때 위 앞니 잇몸이 3mm 이상 노출되어 잇몸이 유난히 많이 보이나요? (Gummy smile) | 심미치료:4 | 심미\n" .
						"보철 심미 실패 | 기존 크라운·브릿지가 잇몸선에 검은 띠가 있거나, 색·투명도가 자연치아와 안 맞나요? | 심미치료:3, 임플란트-센터:1 | 심미\n" .
						"절단연 마모 | 앞니 절단면이 마모되어 짧아지거나 요철·미세 크랙이 있나요? (이갈이·산 부식 원인 감별) | 심미치료:3, 자연치아-살리기:1 | 심미\n" .
						// ── 예방·검진 (10) · 위험군·상태 ──
						"정기검진 시기 | 마지막 치과 검진·스케일링 이후 6개월 이상 경과하여 전반 검진이 필요한 시기인가요? | 예방클리닉:4, 일반-검진:2 | 예방\n" .
						"소아·청소년 | 환자가 만 18세 이하이며 성장기 구강 관리·교합 발달 평가가 필요한 시기인가요? | 예방클리닉:4 | 예방\n" .
						"우식 고위험군 | 당분 섭취가 많거나 최근 3년 내 3회 이상 새 충치가 발생하는 등 우식 고위험군에 해당하나요? | 예방클리닉:3, 자연치아-살리기:1 | 예방\n" .
						"홈 예방 필요 | 어금니 홈이 깊거나 소아 영구치가 새로 나서 실런트 등 홈 밀봉 예방이 필요한 상황인가요? | 예방클리닉:3 | 예방\n" .
						"구강위생 관리 | 양치·치실·치간칫솔 사용이 익숙하지 않아 플라크 관리가 어렵거나 잇몸 문제가 반복되나요? | 예방클리닉:2, 자연치아-살리기:1 | 예방\n" .
						"임신·수유 | 임신·수유 중이거나 임신 계획이 있어 X-ray·마취·약물 사용에 주의가 필요한 상태인가요? | 예방클리닉:3 | 예방 | contra=pregnancy\n" .
						"전신질환 조율 | 고혈압·당뇨·심장질환·골다공증(비스포스포네이트)·항응고제 복용으로 발치·수술 전 조율이 필요한가요? | 예방클리닉:3, 임플란트-센터:1 | 예방 | contra=diabetes,contra=anticoag,contra=bisphos,contra=heart\n" .
						"상실 후 방치 | 발치 후 오래 방치된 부위가 있어 이웃 치아 경사·대합치 정출이 진행 중일 수 있는 상태인가요? | 임플란트-센터:4 | 예방,치아\n" .
						"다치 상실·부분/전악 무치 | 여러 치아 상실 또는 부분/전악 무치 상태로 종합 치료 계획이 필요한 상황인가요? | 임플란트-센터:3, 예방클리닉:2 | 예방\n" .
						"장기 약물 복용 | 스테로이드·면역억제제·항응고제·항암 이력 등으로 상처 회복·감염 관리에 특별한 주의가 필요한가요? | 예방클리닉:3, 임플란트-센터:1 | 예방 | contra=anticoag",
					'label' => '50개 임상 증상 질문 · 카테고리별 10개 (형식: 카테고리 | 질문 | 진료과키:가중치 | chief 태그 | 특수 태그)',
					'type'  => 'textarea',
				),
			),
		),
