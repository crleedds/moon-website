...
function moondental_bot_content_fields() {
	return array(
		...
		'questions' => array(
			'title'  => '셀프진단봇 · 카테고리별 10개씩 (총 50문항)',
			'fields' => array(
				'bot_questions' => array(
					// v3.44.66 · 카테고리별 10문항씩 · chief 태그로 부위 선택 시 관련 10개만 노출
					'default' =>
						// ── 치아 문제 (10) ──
						"응급 통증 | 심한 치통·부종·고름·삼키기 어려운 통증 등 지금 당장 진료가 필요한가요? | 자연치아-살리기:4, 사랑니-발치:2 | 치아,잇몸 | urgent\n" .
						"자발통 | 가만히 있어도 욱신거리거나 잠을 못 잘 정도로 아픈 치아가 있나요? | 자연치아-살리기:4 | 치아\n" .
						"시림 | 차거나 뜨거운 음식·찬바람에 시린 치아가 있나요? | 자연치아-살리기:3, 예방클리닉:1 | 치아\n" .
						"단음식 통증 | 단 음식(초콜릿·사탕 등)을 먹을 때 특정 치아가 시큰거리나요? | 자연치아-살리기:3 | 치아\n" .
						"씹기 통증 | 음식을 씹을 때 특정 부위가 아프거나 불편한가요? | 자연치아-살리기:2, 사랑니-발치:1 | 치아\n" .
						"음식 낌 | 치아 사이에 음식물이 자주 끼거나 빠지지 않는 곳이 있나요? | 자연치아-살리기:2, 예방클리닉:1 | 치아\n" .
						"치아 파손 | 부러지거나 금이 간 치아가 있거나, 최근 이가 깨진 적이 있나요? | 자연치아-살리기:3, 임플란트-센터:1 | 치아\n" .
						"치아 손실 | 빠진 치아가 있거나, 발치 후 비어 있는 자리가 있나요? | 임플란트-센터:4 | 치아\n" .
						"보철물 문제 | 기존 크라운·브릿지·틀니·임플란트가 빠지거나 흔들리거나 불편한가요? | 임플란트-센터:3, 자연치아-살리기:1 | 치아\n" .
						"사랑니 | 어금니 가장 안쪽(사랑니 부위)에 통증·부종이 있거나, 사랑니 발치를 권유받은 적 있나요? | 사랑니-발치:4 | 치아\n" .
						// ── 잇몸·구강 (10) ──
						"잇몸 출혈 | 양치할 때 잇몸에서 자주 피가 나나요? | 자연치아-살리기:3, 예방클리닉:1 | 잇몸\n" .
						"잇몸 붓기 | 잇몸이 붓거나 눌렀을 때 아픈 부위가 있나요? | 자연치아-살리기:3, 예방클리닉:1 | 잇몸\n" .
						"잇몸 퇴축 | 잇몸이 내려앉아 치아 뿌리가 보이거나 치아가 길어 보이나요? | 자연치아-살리기:3 | 잇몸\n" .
						"치아 흔들림 | 흔들리는 치아가 있거나 치아가 들뜨는 느낌이 있나요? | 자연치아-살리기:3, 임플란트-센터:1 | 잇몸,치아\n" .
						"잇몸 고름 | 잇몸에 종기·고름 주머니가 있거나 눌렀을 때 액체가 나오나요? | 자연치아-살리기:4, 사랑니-발치:2 | 잇몸 | urgent\n" .
						"입냄새 | 입냄새가 신경 쓰이거나, 입에서 쓴맛·고름맛이 나나요? | 자연치아-살리기:2, 예방클리닉:2 | 잇몸\n" .
						"이 사이 벌어짐 | 치아 사이 공간이 예전보다 넓어지거나 벌어진 것 같나요? | 자연치아-살리기:2, 투명교정-센터:1 | 잇몸,치아\n" .
						"입 마름 | 입안이 자주 마르거나 침이 부족하다고 느끼시나요? (약 복용·전신질환 등) | 예방클리닉:2 | 잇몸\n" .
						"구내염 반복 | 입안이나 혀에 궤양(구내염)이 자주 반복해서 생기나요? | 예방클리닉:2, 자연치아-살리기:1 | 잇몸\n" .
						"스케일링 미실시 | 최근 6개월~1년 이상 스케일링을 받지 않으셨나요? | 예방클리닉:3, 자연치아-살리기:1 | 잇몸,예방\n" .
						// ── 턱관절·얼굴 (10) ──
						"턱 소리 | 입을 벌리거나 씹을 때 턱에서 딸깍·뚝 소리가 나나요? | 턱관절-클리닉:4 | 턱관절\n" .
						"턱 통증 | 씹거나 말할 때, 또는 가만히 있어도 턱 주변에 통증이 있나요? | 턱관절-클리닉:4 | 턱관절\n" .
						"개구 장애 | 입이 잘 안 벌어지거나, 예전보다 벌리는 크기가 줄었나요? | 턱관절-클리닉:4 | 턱관절\n" .
						"아침 뻐근 | 아침에 일어났을 때 턱이 뻐근하거나 뻣뻣한 느낌이 자주 있나요? | 턱관절-클리닉:3 | 턱관절\n" .
						"이갈이 | 잘 때 이를 갈거나 꽉 무는 습관이 있다고 들으신 적 있나요? | 턱관절-클리닉:3, 심미치료:1 | 턱관절\n" .
						"이악물기 | 낮에 스트레스 받을 때 이를 꽉 물거나 어금니를 물고 있는 습관이 있나요? | 턱관절-클리닉:3 | 턱관절\n" .
						"얼굴 근육통 | 저작근(볼)이나 관자놀이 근육이 자주 뭉치거나 아픈가요? | 턱관절-클리닉:3 | 턱관절\n" .
						"원인 모를 두통 | 관자놀이·귀 앞쪽에서 시작하는 두통이 자주 있나요? | 턱관절-클리닉:2 | 턱관절\n" .
						"목·어깨 통증 | 턱 문제와 함께 목·어깨 통증도 자주 있나요? | 턱관절-클리닉:2 | 턱관절\n" .
						"잘 안 다물리는 입 | 평소 입이 잘 안 다물리거나 입술이 자연스럽게 닫히지 않나요? | 투명교정-센터:2, 턱관절-클리닉:2 | 턱관절,심미\n" .
						// ── 심미·미소 (10) ──
						"치열 | 치아가 비뚤어져 있거나, 치아 사이가 벌어져 있나요? | 투명교정-센터:4 | 심미\n" .
						"돌출 | 위아래 입술이 자연스럽게 안 다물리거나, 앞니가 튀어나와 보이나요? | 투명교정-센터:4 | 심미,치아\n" .
						"교합 | 위아래 치아가 잘 맞물리지 않거나 (개방교합·과개교합 등) 씹을 때 어색한가요? | 투명교정-센터:3, 턱관절-클리닉:1 | 심미,턱관절\n" .
						"치아 변색 | 치아 색이 어둡거나 변색이 있어 미백을 고려하시나요? | 심미치료:3 | 심미\n" .
						"잇몸 색 | 잇몸이 검거나 어두워서 잇몸 미백을 고려하시나요? | 심미치료:3 | 심미\n" .
						"앞니 모양 | 앞니의 모양·길이·잇몸 라인이 마음에 들지 않아 자연스럽게 다듬고 싶으신가요? | 심미치료:4 | 심미\n" .
						"거미스마일 | 웃을 때 잇몸이 많이 보여서 (거미스마일) 신경 쓰이나요? | 심미치료:4 | 심미\n" .
						"심미 보철 | 기존 크라운·앞니 보철이 자연스럽지 않거나 색이 차이나 보이나요? | 심미치료:3, 임플란트-센터:1 | 심미\n" .
						"라미네이트 검토 | 라미네이트로 앞니 모양·색을 한 번에 개선하는 방법에 관심 있으신가요? | 심미치료:3 | 심미\n" .
						"미백 검토 | 전문가 치아 미백에 관심이 있으신가요? | 심미치료:3 | 심미\n" .
						// ── 예방·검진 (10) ──
						"어린이 | 어린이·청소년 환자이신가요? (만 18세 이하) | 예방클리닉:4 | 예방\n" .
						"정기 검진 | 특별한 증상은 없지만 정기 검진·구강 건강 체크를 원하시나요? | 예방클리닉:4, 일반-검진:2 | 예방\n" .
						"스케일링 예약 | 정기 스케일링을 예약하고 싶으신가요? | 예방클리닉:3, 일반-검진:2 | 예방\n" .
						"불소도포 | 충치 예방을 위한 불소도포를 원하시나요? | 예방클리닉:3 | 예방\n" .
						"실란트 | 어금니 홈 메꾸는 실란트(치아 예방 밀봉)를 원하시거나 소아 실란트 상담 원하시나요? | 예방클리닉:3 | 예방\n" .
						"홈케어 조언 | 올바른 양치 방법·치실·치간칫솔 사용법을 배우고 싶으신가요? | 예방클리닉:2, 자연치아-살리기:1 | 예방\n" .
						"임신·수유 | 임신·수유 중이시거나 임신을 준비 중이신가요? (안전 진료 필요) | 예방클리닉:3 | 예방 | contra=pregnancy\n" .
						"전신질환 | 고혈압·당뇨·심장질환·골다공증·항응고제 복용 등 전신 상태가 있어 진료가 망설여지나요? | 예방클리닉:3, 임플란트-센터:1 | 예방 | contra=diabetes,contra=anticoag,contra=bisphos,contra=heart\n" .
						"임플란트 상담 | 임플란트·뼈이식·발치 후 보철 견적·계획을 알아보고 싶으신가요? | 임플란트-센터:4 | 예방,치아\n" .
						"시니어 구강 | 60세 이상이시거나, 틀니·부분틀니 관련 상담을 원하시나요? | 임플란트-센터:2, 예방클리닉:2 | 예방",
					'label' => '50개 질문 · 카테고리별 10개씩 (한 줄에 1개 · 형식: 카테고리 | 질문 | 진료과키:가중치 | chief 태그 | 특수 태그)',
					'type'  => 'textarea',
				),
			),
		),
