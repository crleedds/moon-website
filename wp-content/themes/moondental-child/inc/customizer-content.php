	...
	return array(
		...
		'chrome' => array(
			...
			'fields' => array(
				...
				'enc_hero_lead'           => array( 'default' => '치과 진료·시술·질환에 대한 용어를 알기 쉽게 정리했습니다. 궁금한 용어를 검색하거나 카테고리·초성으로 찾아보세요.', 'label' => '치과사전 · 설명', 'type' => 'textarea' ),
				'enc_search_placeholder'  => array( 'default' => '🔍 용어 검색 (예: 임플란트, 스케일링, 라미네이트…)', 'label' => '치과사전 · 검색 placeholder', 'type' => 'text' ),
				'enc_search_label'        => array( 'default' => '용어 검색', 'label' => '치과사전 · 검색 sr-only 라벨', 'type' => 'text' ),
				'enc_search_btn'          => array( 'default' => '검색', 'label' => '치과사전 · 검색 버튼', 'type' => 'text' ),
				'enc_clear'               => array( 'default' => '전체 보기', 'label' => '치과사전 · 필터 초기화', 'type' => 'text' ),
				'enc_cats_all'            => array( 'default' => '전체', 'label' => '치과사전 · 카테고리 탭 · 전체', 'type' => 'text' ),
				'enc_cats_aria'           => array( 'default' => '분야', 'label' => '치과사전 · 카테고리 탭 aria', 'type' => 'text' ),
				'enc_initials_aria'       => array( 'default' => '초성 필터', 'label' => '치과사전 · 초성 탭 aria', 'type' => 'text' ),
				'enc_count_unit'          => array( 'default' => '개 용어', 'label' => '치과사전 · 카운트 단위', 'type' => 'text' ),
				'enc_search_label_prefix' => array( 'default' => '검색어:', 'label' => '치과사전 · 검색어 표시 접두', 'type' => 'text' ),
				'enc_empty_title'         => array( 'default' => '😔 검색 결과가 없습니다.', 'label' => '치과사전 · 빈결과 · 제목', 'type' => 'text' ),
				'enc_empty_hint_tpl'      => array( 'default' => '다른 검색어를 시도하거나 {link}를 확인해보세요.', 'label' => '치과사전 · 빈결과 · 힌트 ({link} 토큰)', 'type' => 'text' ),
				'enc_empty_hint_link'     => array( 'default' => '전체 용어', 'label' => '치과사전 · 빈결과 · 링크 텍스트', 'type' => 'text' ),
			),
		),
