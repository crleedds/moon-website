...
function moondental_bot_content_fields() {
	return array(
		'ui' => array(
			'title'  => '셀프진단봇 · UI 문구',
			'fields' => array(
				'bot_count_template'    => array( 'default' => '{count}개의 Yes/No 질문 · 약 1분 소요 · 모든 진료영역 망라', 'label' => '질문 개수 안내 (토큰 {count})', 'type' => 'text' ),
		...
		'questions' => array(
			'title'  => '셀프진단봇 · 10개 고밀도 질문',
			'fields' => array(
				'bot_questions' => array(
					// v3.44.64 · 30개 → 10개 압축 (8개 진료과 전부 커버, 가중치 최적화)
					'default' =>
						"응급 통증 | 심한 치통·부종·고름·삼키기 어려운 통증 등 지금 당장 진료가 필요한 응급 상황인가요? | 자연치아-살리기:4, 사랑니-발치:2 | 치아,잇몸 | urgent\n" .
						"시림·시큰 | 차거나 뜨거운 것, 단 음식을 먹을 때 특정 치아가 시리거나 시큰거리나요? (충치·마모 의심) | 자연치아-살리기:3, 예방클리닉:1 | 치아\n" .
						"잇몸 문제 | 양치할 때 잇몸에서 자주 피가 나거나, 잇몸이 붓거나 내려앉는 느낌이 있나요? (구취·음식 낌 포함) | 자연치아-살리기:3, 예방클리닉:2 | 잇몸\n" .
						"치아 손실·보철 | 빠진 치아·흔들리는 치아·부러진 치아가 있거나, 기존 크라운·틀니·임플란트에 문제가 있나요? | 임플란트-센터:3, 자연치아-살리기:2 | 치아\n" .
						"치열·교합 | 치아가 비뚤어져 있거나, 앞니가 튀어나와 입이 잘 안 다물어지거나 위아래 맞물림이 어색한가요? | 투명교정-센터:4 | 심미,치아\n" .
						"턱관절·이갈이 | 입을 벌리거나 씹을 때 턱에서 소리·통증이 있거나, 이갈이·이악물기 습관이 있나요? | 턱관절-클리닉:4, 심미치료:1 | 턱관절\n" .
						"사랑니 | 어금니 가장 안쪽(사랑니 부위)이 아프거나 부었거나, 사랑니 발치를 권유받은 적이 있나요? | 사랑니-발치:4 | 치아\n" .
						"심미 개선 | 치아 색·앞니 모양·잇몸 라인·거미스마일 등 미소를 자연스럽게 개선하고 싶으신가요? (미백·라미네이트·잇몸 성형) | 심미치료:4 | 심미\n" .
						"예방·검진·소아 | 특별한 증상은 없지만 정기 검진·스케일링·불소도포를 원하시거나, 만 18세 이하 어린이·청소년이신가요? | 예방클리닉:4, 일반-검진:2 | 예방\n" .
						"임플란트 상담·전신질환 | 임플란트·발치 후 보철 견적을 원하시거나, 전신질환(고혈압·당뇨·골다공증·항응고제·임신 등)으로 안전 진료 상담이 필요하신가요? | 임플란트-센터:3, 예방클리닉:1 | 치아,예방 | contra=diabetes,contra=anticoag,contra=bisphos,contra=pregnancy",
					'label' => '10개 질문 (한 줄에 1개, 형식: 카테고리 | 질문 | 진료과키:가중치 | chief 태그 | 특수 태그)',
					'type'  => 'textarea',
				),
			),
		),
