	...
	return array(
		...
		'seo' => array(
			...
			'fields' => array(
				...
				'seo_home_desc'  => array( 'default' => '천안·아산 치과병원. 임플란트·투명교정·라미네이트·전문가 치아미백·신경치료·잇몸·매복사랑니·턱관절·소아 4개 전문센터 분과별 협진 시스템. 야간진료.', 'label' => '홈 · Google 검색 설명 (구글 검은 요약 문구)', 'type' => 'textarea' ),
