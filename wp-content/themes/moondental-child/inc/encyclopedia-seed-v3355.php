...
function moondental_encyclopedia_seed_data_v3355() {
	return array(
		...
		array( '천안 소아치과', 'general', '아이 친화 소아치과', '<p>Pediatric Dental. <strong>소아치과·친화 환경</strong>.</p>' ),
		array( '천안 임플란트 잘하는 곳', 'implant', '30여년 임상 실적', '<p>Cheonan Implant Clinic. <strong>임상 실적·CBCT·기공소·A/S</strong> 확인.</p>' ),
		array( '천안 사랑니 발치', 'surgery', '구강외과 진료 필요', '<p>Cheonan Wisdom Tooth. <strong>구강외과·CBCT 진단</strong>.</p>' ),
		array( '천안 신경치료', 'preserve', '보존과', '<p>Cheonan Endo. <strong>보존과·마이크로스코프·CBCT</strong>.</p>' ),
		array( '천안 잇몸 치료', 'periodontics', '치주과', '<p>Cheonan Periodontics. <strong>치주과·SRP·수술</strong>.</p>' ),
		array( '천안 어린이 치과', 'pediatric', '소아치과 전문', '<p>Cheonan Kids Dental. <strong>소아치과·친화 환경</strong>.</p>' ),
