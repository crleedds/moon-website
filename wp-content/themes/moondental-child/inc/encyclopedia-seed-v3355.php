...
function moondental_encyclopedia_seed_data_v3355() {
	return array(
		...
		array( '자폐 아동 치과', 'general', '점진적 노출·소아치과 전문의', '<p>Autism. <strong>점진 노출·시각 지원·소아치과 전문의</strong>.</p>' ),
		...
		/* === 지역·병원 관련 SEO (신규) === */
		array( '천안 치과병원', 'general', '천안 종합 치과병원 안내', '<p>Cheonan Dental. <strong>천안 만남로 문치과병원 등</strong> 종합 치과병원.</p>' ),
		array( '아산 치과', 'general', '아산 인근 치과 안내', '<p>Asan Dental. <strong>아산·천안 인근 치과</strong>. 통합 진료.</p>' ),
		array( '천안 종합 치과', 'general', '전 진료 영역 통합', '<p>Comprehensive Dental. <strong>임플란트·교정·심미·자연치아·구강외과</strong> 통합.</p>' ),
		array( '천안 예방 치과', 'general', '스케일링·불소·정기 검진', '<p>Preventive Dental. <strong>스케일링·에어플로우·불소·실런트</strong>.</p>' ),
		...
		array( '천안 소아치과', 'general', '아이 친화 소아치과', '<p>Pediatric Dental. <strong>소아 전문의·친화 환경</strong>.</p>' ),
		array( '천안 임플란트 잘하는 곳', 'implant', '30여년 임상 실적', '<p>Cheonan Implant Clinic. <strong>임상 실적·CBCT·기공소·A/S</strong> 확인.</p>' ),
		array( '천안 사랑니 발치', 'surgery', '구강외과 전문의 필요', '<p>Cheonan Wisdom Tooth. <strong>구강외과 전문의·CBCT 진단</strong>.</p>' ),
		array( '천안 신경치료', 'preserve', '보존과 전문의', '<p>Cheonan Endo. <strong>보존과 전문의·마이크로스코프·CBCT</strong>.</p>' ),
		array( '천안 잇몸 치료', 'periodontics', '치주과 전문의', '<p>Cheonan Periodontics. <strong>치주과 전문의·SRP·수술</strong>.</p>' ),
		array( '천안 어린이 치과', 'pediatric', '소아치과 전문', '<p>Cheonan Kids Dental. <strong>소아치과 전문의·친화 환경</strong>.</p>' ),
		array( '천안 야간 응급 치과', 'general', '응급 상황 대비', '<p>Emergency Night. <strong>야간 응급 치과·사전 문의</strong> 필수.</p>' ),
		array( '아산 임플란트', 'implant', '아산·천안 임플란트 전문', '<p>Asan Implant. <strong>아산 인근 임플란트 전문 병원</strong>.</p>' ),
		...
		array( '전문 치과', 'general', '11개 세부 전문의', '<p>Specialty Dental. <strong>보철·교정·보존·치주·외과·소아·구강내과·영상·병리·통합·예방</strong>.</p>' ),
		...
		array( '치과 순위', 'general', '단순 순위보다 실적·전문성 확인', '<p>Dental Ranking. <strong>순위보다 임상 실적·전문의</strong> 확인.</p>' ),
		array( '치과 추천', 'general', '지인·후기·상담 종합', '<p>Recommendation. <strong>지인 추천·리뷰·직접 상담</strong> 종합 판단.</p>' ),
		array( '치과 신뢰도', 'general', '전문의·경력·시설 확인', '<p>Trust. <strong>전문의 자격·임상 경력·시설·A/S</strong>.</p>' ),
