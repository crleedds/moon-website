...
function moondental_seo_page_map() {
	return array(
		// 홈 (front page)
		'_home' => array(
			'title' => '천안·아산 치과 문치과병원 · 임플란트 · 투명교정 · 자연치아 살리기 30년',
			'desc'  => '천안·아산 문치과병원 30년 전통, 만남로 문타워. 임플란트·투명교정·자연치아 살리기·소아·교정 진료과 협진. 카카오톡·네이버 24시간 예약, 041-563-2875.',
		),
		// 진료 페이지
		'임플란트-센터' => array(
		...
		'천안-추천-치과' => array(
			'title' => '천안 추천 치과 · 임플란트·교정·자연치아 살리기 - 문치과병원 (30년)',
			'desc'  => '천안 추천 치과 문치과병원. 1995년 개원 30여년 · 진료과별 협진 · 4개 층 통합 진료실 · 임플란트·투명교정·자연치아 살리기·심미치료. 상담 041-563-2875.',
		),
		'아산-추천-치과' => array(
			'title' => '아산 추천 치과 · 임플란트·교정·자연치아 살리기 - 문치과병원 (20분)',
			'desc'  => '아산 추천 치과 문치과병원. 아산 배방·탕정에서 20~22분 · 30여년 진료 · 진료과 협진 · 임플란트·투명교정·자연치아 살리기. 상담 041-563-2875.',
		),
	);
}
...
function moondental_jsonld_sitenav() {
	...
	$nav = array(
		...
		array( 'name' => '임플란트 센터',       'url' => $home . '진료항목/임플란트-센터/',       'desc' => '천안·아산 임플란트 · CBCT 3D 네비게이션' ),
		...
		array( 'name' => '천안 추천 치과',       'url' => $home . '천안-추천-치과/',       'desc' => '천안 대표 종합 치과 · 30년 진료 · 진료과 협진' ),
		array( 'name' => '아산 추천 치과',       'url' => $home . '아산-추천-치과/',       'desc' => '아산에서 20분 · 문치과병원 · 진료과 협진' ),
	);
