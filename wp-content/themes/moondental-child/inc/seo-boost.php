...
function moondental_seo_page_map() {
	return array(
		...
		'_home' => array(
			...
			'desc'  => '천안 문치과병원 30년 전통, 만남로 문타워. 임플란트·투명교정·자연치아 살리기·소아·교정 진료과 협진. 카카오톡·네이버 24시간 예약, 041-563-2875.',
		),
		// 진료 페이지
		'임플란트-센터' => array(
		...
		'심미치료' => array(
			'title' => '천안 라미네이트 · 미백 · 심미치료 - 문치과병원 스마일 디자인 센터 (10F)',
			'desc'  => '천안 심미치료 문치과병원 스마일 디자인 센터(10F). 라미네이트·전문가 미백·세라믹 크라운·심미 보철 · 자연스러운 미소 디자인. 심미 상담 041-563-2875.',
		),
		'예방클리닉' => array(
		...
		// 병원 소개
		'의료진' => array(
			'title' => '문치과병원 의료진 · 원장 · 진료과 소개 - 천안 치과',
			'desc'  => '천안 문치과병원 의료진 소개. 원장 · 보존·보철·교정·구강외과·소아 등 진료과 협진 시스템. 환자별 맞춤 진료 팀 문치과병원.',
		),
		'역사' => array(
