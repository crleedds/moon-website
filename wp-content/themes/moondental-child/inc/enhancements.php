...
function moondental_seo_meta_tags() {
	...
	if ( ! $meta_title && is_front_page() ) {
		...
		$meta_desc     = '천안 만남로 1995년 개원 30여년 한자리 진료. 천안 임플란트·천안 투명교정·천안 라미네이트·천안 사랑니 발치·천안 턱관절 치료. 분야별 전문 의료진 협진·CBCT 디지털 가이드·월·화·수·금 야간진료(20:30).';
		...
		$service_map = array(
			...
			'상담예약'         => array(
				...
				'desc'  => '천안 만남로 문치과병원 예약. 네이버 예약 24시간, 전화·카카오톡 상담. 월·화·수·금 야간진료 20:30까지 (목 18:00·토 14:00).',
